...
//        return $cartCollections;
        return view('front.cart.index')->with(['cartCollections' => $cartCollections]);
    }
    ...
    public function get_header_cart()
    {
        ...
        foreach (cart_content() as $product_) {
            ...
            $cart_products_['image'] = $product->main_image;
            $cart_products_['title'] = get_lang() == 'ar' ? $product->title_ar : $product->title_en;
            $cart_products_['price'] = curreny_price($product->eg_price, $product->em_price);
